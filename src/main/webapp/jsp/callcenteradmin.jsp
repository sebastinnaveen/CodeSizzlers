                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       <!--  <li class="sidebar-search">
                        ...
                        <li>
                            <a href="../jsp/login.jsp"><i class="fa fa-table fa-fw"></i> Fios Dispatch Requests</a>
                        </li>
                        <li>
                            <a href="../jsp/dispatch.jsp"><i class="fa fa-dashboard fa-fw"></i>General Complaints</a>
                        </li>
                        <li>
                            <a href="../jsp/dispatch.jsp"><i class="fa fa-dashboard fa-fw"></i>Technician Availability</a>
                        </li>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td>15000110</td>
                                            <td>Fios BroadBand Complaint</td>
                                            <td>Wilcher</td>
                                            <td >31/10/2015</td>
                                            <td >Robert</td>
                                            <td>Completed</td>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                            ...
                            Fios Dispatch Outstanding Queue
